...
if __name__ == '__main__':
    ...
    logger = setup_logger('RASC', save_dir=args.output_dir, if_train=args.training, distributed_rank=get_rank())
    ...
    if getattr(args, "case_vis_enable", False):
        args.return_img_path = True
        args.return_raw_caption = True
        args.vis_dir = op.join(args.output_dir, "noise_case_vis")
    ...
    optimizer_warm = build_optimizer(args, model, mode="warm")
    scheduler = build_lr_scheduler(args, optimizer)
    scheduler_warm = build_lr_scheduler(args, optimizer_warm)
